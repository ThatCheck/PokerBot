...
{
    public class PositionTurn: Position
    {
        public PositionTurn(List<HandHistories.Objects.Actions.HandAction> list, String player)
            : base(list, player, HandHistories.Objects.Cards.Street.Turn) 
        {
        ...
        {
            return new String[] { typeof(Action.ActionTurn).Name, typeof(PositionRiver).Name };
        }
    }
}
