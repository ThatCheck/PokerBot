...
{
    public class PositionFlop : Position
    {
        public PositionFlop(List<HandHistories.Objects.Actions.HandAction> list, String player) : base (list,player,HandHistories.Objects.Cards.Street.Flop) 
        {
        ...
        {
            return new String[] { typeof(Action.ActionFlop).Name, typeof(PositionTurn).Name };
        }
    }
}
