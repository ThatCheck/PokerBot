...
//%Card+3
/// <exclude/>
public class CardLexer : TOKEN{ public override string yyname { get { return "Card";}}
/// <exclude/>
public override int yynum { get { return 3; }}
/// <exclude/>
public CardLexer(Lexer yyl) : base(yyl) { }
}
/// <exclude/>
public class Card_1 : CardLexer
{
  /// <exclude/>
...
/// <exclude/>
public static object Card_factory(Lexer yyl) { return new CardLexer(yyl); }
/// <exclude/>
