...
namespace Benchmark
{
    class TestLoopEvaluate : ITest
    {
        ...
        #region Constructor
        public TestLoopEvaluate(System.Windows.Forms.Form form)
        {
            ...
            // Set the Titles
            graphpane.Title.Text = "Hands()/Evaluate";
